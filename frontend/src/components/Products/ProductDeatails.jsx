...
const selectedProducts = {
  ...
  price: 120,
  originalPrice: 150,
  description: "This is a Stylist Jacket perfect for ant occasion",
  brand: "FashionBrand",
  material: "Leather",
  sizes: ["S", "M", "L", "XL"],
...
const ProductDeatails = () => {
  ...
  useEffect(() => {
    setMainImages(selectedProducts.images[0].url);
          ...
          <div className="md:w-1/2">
            <div className="mb-4">
              <img
                src={mainImages}
                alt="Main Product"
                className="w-full h-auto object-auto rounded-lg"
              />
            </div>
          </div>
          {/* Mobile Thumnail */}
